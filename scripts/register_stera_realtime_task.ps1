$action = New-ScheduledTaskAction -Execute "C:\Users\xxxun\AppData\Local\Programs\Python\Python312\python.exe" -Argument '"C:\Users\xxxun\internal-web-system\scripts\poll_stera_realtime_sales.py"' -WorkingDirectory "C:\Users\xxxun\internal-web-system"
...
$principal = New-ScheduledTaskPrincipal -UserId "xxxunknouw00" -LogonType Interactive -RunLevel Limited

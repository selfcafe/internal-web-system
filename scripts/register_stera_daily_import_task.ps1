$action = New-ScheduledTaskAction -Execute "C:\Users\80000785\AppData\Local\Programs\Python\Python312\python.exe" -Argument '"C:\Users\80000785\internal-web-system\scripts\import_stera_daily_sales.py"' -WorkingDirectory "C:\Users\80000785\internal-web-system\scripts"
